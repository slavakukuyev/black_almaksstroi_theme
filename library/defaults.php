...
<div class="content-layout">
    ...
    <div class="layout-cell" style="width: 100%">
        <div style="position:relative;display:inline-block;padding-left:40px;padding-right:40px"><a title="RSS" class="rss-tag-icon" style="position: absolute; bottom: -10px; left: -6px; line-height: 30px;" href="#"></a>
        <p><br></p>
        <p>BizGroup © 2011-2012. Все Права Защищены.<a href="#">Privacy Policy</a></p>
        </div>
    </div>
    </div>
</div>
